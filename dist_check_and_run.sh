...
export 
nohup ./gameserver -gip 127.0.0.1 -seq replay -d 1 -m 10000 -b 150 -t 2000 -h 500 0</dev/null 1>/dev/null 2>/dev/null  & 
popd >/dev/null
...
do
  nohup ./check 127.0.0.1 6000 127.0.0.$i 600$i $i$i$i$i 0</dev/null 1>/dev/null 2>/dev/null &
done
popd >/dev/null
